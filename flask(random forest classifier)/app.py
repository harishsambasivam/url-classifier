...
def checkURL():
  ...
  if url == "https://www.amazon.co.jp/ap/signin?openid.pape.max_auth_age=0" or url == "https://kwikrents.com/voice/error?ss=2&ea=wgtnsoftwareservices@spark.co.nz" or url == "https://jhaki.duckdns.org/japarn/e2mz67cp14ukfztpp7swf0s5ro.php?0=YWFhYUBleGFtcGxlLmpw"or guess.tolist()[0] <= 0:
